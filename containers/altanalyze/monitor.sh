...
# This is a vendored copy placed in the altanalyze build context
# so Docker builds on GitHub Actions can COPY it without needing
# repo-root paths. It mirrors containers/resource-monitor/monitor.sh.
